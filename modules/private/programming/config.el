...
(after! magit
  ...
  (undefine-key! magit-mode-map "q")
  (define-key magit-mode-map "q" #'magit-quit-session)
  (define-key! 'normal (magit-mode-map) "q" #'magit-quit-session)
  (define-key! 'visual (magit-mode-map) "q" #'magit-quit-session)
  ;; }}
